...
//passport and security staff -- Test
...
app.post( "/proxy/apic/SalesOrderFromBookingProgram", (req, res, next ) => {
	apiUtil.ProcessRequest("IBMAPIC", req, res, next, (...args) => proxyHandler.apiIbmApicProxy(...args));
});
